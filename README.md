## Visualizing Data Project – Part 1
...
This revealed who carries the burden of collecting water — **women and children**, especially in unsafe hours.
...
- **43%** use **shared taps** — up to **2000 people sharing one**
- **31%** have in-home taps — but **45% are dysfunctional**
- **18%** use wells — only **28% are clean**
